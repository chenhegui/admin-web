<template>
	<div>
		...
		<div class="container">
			<el-card class="filter-container" shadow="never">
				...
				<div style="margin-top: 15px">
					<div v-if="data && data.id">
						<el-tag style="margin: 0 12px 10px 0;" type="primary" closable :disable-transitions="false" @close="handleCloseTag(data)">
			...
			<el-card class="filter-container magin-top-20" shadow="never">
				...
				<div style="margin-top: 15px">
					<div v-if="item && item.id">
						<el-tag style="margin: 0 12px 10px 0;" type="primary">
			...
			<el-card class="filter-container magin-top-20" shadow="never">
				<div class="top-title" style="overflow: hidden;">
			...
			<div>
				<div class="table-container">
					<el-table ref="table" :data="table" style="width: 100%" highlight-current-row @current-change="handleTableProductChange"
					 v-loading="listLoading" current-row-key="id" row-key="id">
